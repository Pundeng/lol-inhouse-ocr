...
def parse_lists(player_names, kda_cs_gold, objectives, vision, damages):
    # summary data
    summary_data = {
        "player_name": [],
        "kills": [],
    ...
    return summary_data, vision_data, damage_data
...
def main():
    ...
    summary_data, vision_data, damage_data = parse_lists(player_names, kda_cs_gold, objectives, vision, damages)
